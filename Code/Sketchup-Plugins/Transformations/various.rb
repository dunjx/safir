...
module Various_plugin
    ...
    def self.various
      ...
      # -- COLORING INPUT
          ...
          if input_color[0].upcase == "ADC" or input_color[0].upcase == "ALL DIFFERENT COLORS" # Each unit is a different color, chosen by the random generator.
              color_option = "d"
          end
          if input_color[0].upcase == "G" or input_color[0].upcase == "GRADIENT" # Coloring object as a gradient between two colors.
              color_option = "g"
